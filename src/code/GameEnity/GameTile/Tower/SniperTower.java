...
public class SniperTower extends Rectangle implements Tower{
    private final int SPEED_SHOOTING_ = SPEED_SHOOTING[1];
    private int count_time_ = SPEED_SHOOTING_;
    private final double SPEED_BULLET_ = SPEED_BULLETS[1];
    private final int range_ = RANGE[1];
    private final int DAMAGE_ = DAMAGE[1];
